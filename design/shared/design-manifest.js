 ...
 * 
 * 카테고리별 디자인 문서 목록 + 뷰포트 설정.
 * 새 화면 추가 시 해당 카테고리 items에 항목 추가.
 * 
...
window.__DESIGN_MANIFEST__ = {
    miniapp: {
        ...
        items: [
            ...
            { name: "Biz 랜딩", file: "miniapp/biz-landing", status: "done" },
            { name: "Biz 주문 플로우", file: "miniapp/biz-order-flow", status: "done" },
            { name: "Biz 주문 관리", file: "miniapp/biz-order-list", status: "done" }
        ]
    },
    admin: {
        ...
        items: [
            ...
            { name: "Biz 주문 관리", file: "admin/biz-order-management", status: "done" }
        ]
    },
    web: {
        ...
        items: [
            ...
            { name: "비즈니스 랜딩", file: "web/business", status: "done" }
        ]
    },
    shared: {
        label: "Design System",
