...
window.__TEST_MANIFEST__ = {
  admin: {
    ...
    items: [
      ...
      { file: "admin/dashboard.js", feature: "대시보드", screen: "dashboard", totalCases: 13 },
      { file: "admin/challenge-management.js", feature: "챌린지 관리", screen: "challenge-management", totalCases: 16 },
      ...
      { file: "admin/settlement.js", feature: "정산", screen: "settlement", totalCases: 24 },
  ...
  miniapp: {
    label: "Mini App",
    items: [
      { file: "miniapp/home.js", feature: "홈", screen: "home", totalCases: 25 },
      { file: "miniapp/challenge-list.js", feature: "챌린지 목록", screen: "challenge-list", totalCases: 30 },
      { file: "miniapp/challenge-detail.js", feature: "챌린지 상세", screen: "challenge-detail", totalCases: 12 },
      { file: "miniapp/challenge-participation.js", feature: "챌린지 참여", screen: "challenge-detail, my-challenges", totalCases: 44 },
      { file: "miniapp/verification-submit.js", feature: "인증 제출", screen: "verification-submit", totalCases: 43 },
  ...
  web: {
    label: "Web (Public)",
    items: [
      { file: "web/public-pages.js", feature: "공개 웹 페이지", screen: "public-pages", totalCases: 27 }
    ]
  }
};
