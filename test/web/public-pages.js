...
window.__TEST_DATA__ = {
  ...
  "cases": [
    ...
    },
    {
      ...
      "expected": "챌린지 이름, 설명, 카테고리 뱃지, 난이도 뱃지, 기간(시작~종료일), 인증 빈도, 예치금 범위, 리워드율 표시 (참여자 수 미표시), 'Join Challenge in Telegram' CTA 버튼",
    ...
    },
    {
      ...
      "type": "normal",
      "regression": true,
      "regressionNote": "2026-06-18 CTA URL startapp=c_{encodedId} 딥링크 형태로 변경",
      "scenario": "CTA 버튼 클릭 시 Telegram 딥링크 이동",
      "precondition": "챌린지 공개 상세 페이지 표시 (encodedId=AbCdEf12)",
      "action": "'Join Challenge in Telegram' 버튼 클릭",
      "expected": "https://t.me/{봇이름}/app?startapp=c_AbCdEf12 URL로 이동, Telegram 설치 시 Mini App 열림",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-006",
    ...
    },
    {
      ...
      "type": "normal",
      "regression": true,
      "regressionNote": "2026-06-18 sitemap-categories.xml 포함 확인 추가",
      "scenario": "sitemap.xml (index) 정상 응답",
      "precondition": "active 챌린지 1건 이상 존재, active 카테고리 1건 이상 존재",
      "action": "https://도메인/sitemap.xml 접속",
      "expected": "sitemapindex XML, sitemap-challenges-1.xml + sitemap-categories.xml 포함, Content-Type: application/xml",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-011",
    ...
    },
    {
      ...
      "regressionNote": "",
      "scenario": "풀 헤더 정상 표시",
      "precondition": "공개 웹 페이지 (/, /categories/*, /challenges/*, /events, /leaderboard, /terms, /privacy) 접속",
      "action": "페이지 상단 헤더 영역 확인",
      "expected": "로고(DefyTON, 클릭→/), Categories▾ 드롭다운(active 카테고리 표시), Events 링크(→/events), Leaderboard 링크(→/leaderboard), 'Open in Telegram' CTA 버튼",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-020",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "모바일 헤더 (768px 이하)",
      "precondition": "브라우저 뷰포트 768px 이하 또는 모바일 기기",
      "action": "햄버거 메뉴(☰) 클릭",
      "expected": "메뉴 펼침: Categories 서브메뉴(펼침/접힘), Events, Leaderboard, Open in Telegram 순서로 표시",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-021",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "공통 푸터 정상 표시",
      "precondition": "풀 헤더 적용 페이지 접속",
      "action": "페이지 하단 푸터 영역 확인",
      "expected": "DefyTON 브랜드, Popular Categories 상위 5개 링크, Challenges·Events·Leaderboard·Terms·Privacy 링크, © 2026 DefyTON. All rights reserved.",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-022",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "카테고리 공개 페이지 — 활성 카테고리 정상 표시",
      "precondition": "active=true 카테고리 존재, 소속 챌린지 1개 이상",
      "action": "https://도메인/categories/{slug} 접속",
      "expected": "브레드크럼(Home > Category) + 카테고리명(h1) + 설명 + Available Now 챌린지 카드(2열) + Past Challenges + CTA + JSON-LD(CollectionPage) + OG 메타태그",
      "dbCheck": "CHALLENGE_CATEGORY(name→slug 매칭, active=true), CHALLENGE(category_id=해당, active=true) 조회 확인"
    },
    {
      "id": "PW-N-023",
      "type": "normal",
      "regression": false,
      "regressionNote": "",
      "scenario": "빈 카테고리 (챌린지 0개)",
      "precondition": "active=true 카테고리, 소속 챌린지 0개",
      "action": "https://도메인/categories/{slug} 접속",
      "expected": "200 OK, 'Coming Soon' 메시지 표시, <meta name=\"robots\" content=\"noindex\"> 포함",
      "dbCheck": "CHALLENGE(category_id=해당) 0건 확인"
    },
    {
      "id": "PW-N-024",
      "type": "normal",
      "regression": false,
      "regressionNote": "",
      "scenario": "비활성/존재하지 않는 카테고리 → 404",
      "precondition": "active=false 카테고리 또는 존재하지 않는 slug",
      "action": "https://도메인/categories/invalid-slug 접속",
      "expected": "404 에러 페이지 표시, 'Open in Telegram' CTA 버튼",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-025",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "카테고리 OG 이미지 동적 생성",
      "precondition": "active 카테고리 존재",
      "action": "https://도메인/og/categories/{slug}.jpg 접속",
      "expected": "1200×630 JPEG 이미지 반환, 카테고리 아이콘+displayName+챌린지 수+DefyTON 브랜딩, Cache-Control: public, max-age=86400",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-026",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "Other Categories 섹션 (현재 카테고리 제외 최대 4개)",
      "precondition": "active 카테고리 3개 이상 존재",
      "action": "https://도메인/categories/{slug} 접속 후 하단 확인",
      "expected": "현재 카테고리 제외 최대 4개 카테고리 카드 표시 (아이콘+displayName+'N challenges'), challengeCount DESC 정렬",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-027",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "카테고리 페이지 Freshness 날짜 표시",
      "precondition": "active 카테고리 페이지 접속",
      "action": "Available Now 섹션 타이틀 옆 확인",
      "expected": "'Updated {MMM d, yyyy}' 형태로 오늘 날짜 표시 (서버 렌더링 시점)",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-028",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "이벤트 공개 페이지 — 챌린지 목록 정상 표시",
      "precondition": "active EVENT 챌린지 1건 이상 존재",
      "action": "https://도메인/events 접속",
      "expected": "이벤트 챌린지 카드 2열 표시 (챌린지명+카테고리뱃지+기간+예치금+리워드), sortOrder ASC 정렬",
      "dbCheck": "CHALLENGE(challenge_type=EVENT, active=true) 조회 확인"
    },
    {
      "id": "PW-N-029",
      "type": "normal",
      "regression": false,
      "regressionNote": "",
      "scenario": "이벤트 0개 — 빈 상태",
      "precondition": "active EVENT 챌린지 0건",
      "action": "https://도메인/events 접속",
      "expected": "'No events at the moment. Stay tuned!' 메시지 + 홈 CTA 버튼 표시",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-030",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "이벤트 페이지 캐시 확인",
      "precondition": "/events 접속",
      "action": "응답 헤더 확인",
      "expected": "Cache-Control: public, max-age=600 (10분)",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-031",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "완료 공유 페이지 — COMPLETED 표시",
      "precondition": "status=COMPLETED인 참여 존재 (encodedId 유효)",
      "action": "https://도메인/challenges/completed/{encodedId} 접속",
      "expected": "'🏆 Challenge Completed!' + 달력 또는 프로그레스바 + 통계(100% Completion, Best Streak, Verifications) + 'Earned Reward ✓' + CTA",
      "dbCheck": "CHALLENGE_PARTICIPATION(id=decoded, status=COMPLETED) 조회 확인"
    },
    {
      "id": "PW-N-032",
      "type": "normal",
      "regression": false,
      "regressionNote": "",
      "scenario": "완료 공유 페이지 — FAILED 표시",
      "precondition": "status=FAILED인 참여 존재 (encodedId 유효)",
      "action": "https://도메인/challenges/completed/{encodedId} 접속",
      "expected": "'💪 Challenge Attempted!' + 부분 달력 또는 프로그레스바 + 통계(X% Completion, Best Streak, Verifications) + CTA (리워드 미표시)",
      "dbCheck": "CHALLENGE_PARTICIPATION(id=decoded, status=FAILED) 조회 확인"
    },
    {
      "id": "PW-N-033",
      "type": "normal",
      "regression": false,
      "regressionNote": "",
      "scenario": "달력 vs 프로그레스바 분기 확인",
      "precondition": "15일 이상 챌린지 COMPLETED 참여 + 14일 이하 챌린지 COMPLETED 참여",
      "action": "각각 /challenges/completed/{encodedId} 접속",
      "expected": "15일 이상: 달력(인증 성공일 초록, 미인증일 회색) 표시, 14일 이하: 프로그레스바('X/Y days ✓') 표시",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-E-011",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "완료 공유 — decode 실패 또는 ACTIVE/GIVEN_UP → 404",
      "precondition": "잘못된 encodedId 또는 status=ACTIVE/GIVEN_UP인 참여",
      "action": "https://도메인/challenges/completed/{invalidOrActiveId} 접속",
      "expected": "404 에러 페이지 표시",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-034",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "랜딩 페이지 개편 — 구조 확인",
      "precondition": "active 카테고리 + 챌린지 존재",
      "action": "https://도메인/ 접속",
      "expected": "Hero + How It Works + Browse Challenges(카테고리 2열 그리드, 아이콘+displayName+'N challenges') + Popular Challenges(상위 6개 카드) + Key Features + Bottom CTA 순서 표시",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-035",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "참여자 수 미표시 확인 (Coming Soon 비공개 정책)",
      "precondition": "랜딩 페이지 + 카테고리 페이지 + 챌린지 상세 페이지",
      "action": "각 페이지에서 참여자 수 관련 텍스트 검색",
      "expected": "참여자 수('N joined', 'X participants') 어디에도 표시되지 않음",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-036",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "랜딩 페이지 Freshness 날짜 표시",
      "precondition": "/ 접속",
      "action": "Popular Challenges 섹션 확인",
      "expected": "'🔥 Challenges available today — {MMM d, yyyy}' 형태로 오늘 날짜 표시",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-037",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "챌린지 상세 — 브레드크럼 표시",
      "precondition": "챌린지 공개 상세 페이지 접속",
      "action": "페이지 상단 브레드크럼 영역 확인",
      "expected": "Home > {Category} > {Challenge} 브레드크럼 표시, Home→/, Category→/categories/{slug} 링크 동작",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-038",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "챌린지 상세 — Related Challenges 섹션",
      "precondition": "같은 카테고리에 다른 active 챌린지 존재",
      "action": "챌린지 공개 상세 페이지 하단 확인",
      "expected": "Related Challenges 섹션에 같은 카테고리 챌린지 2~3개 카드 표시, 각 카드 클릭 시 해당 상세 이동",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-039",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "챌린지 OG 이미지 동적 생성",
      "precondition": "active 챌린지 존재 (encodedId 유효)",
      "action": "https://도메인/og/challenges/{encodedId}.jpg 접속",
      "expected": "1200×630 JPEG 이미지 반환, 챌린지명+카테고리+기간+DefyTON 브랜딩, Cache-Control: public, max-age=86400",
      "dbCheck": "변경 없음"
    },
    {
      "id": "PW-N-040",
      ...
      "regression": false,
      "regressionNote": "",
      "scenario": "리더보드 공개 페이지 — Coming Soon 표시",
      "precondition": "서버 정상 동작",
      "action": "https://도메인/leaderboard 접속",
      "expected": "'🏆 Leaderboard' 타이틀 + Coming Soon 메시지 + CTA 버튼 표시, 풀 헤더 + 풀 푸터 포함",
      "dbCheck": "변경 없음"
    }
  ]
};
